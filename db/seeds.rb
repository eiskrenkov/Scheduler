...
Pair.create(id: 9, name: 'Физкультура', kind: 3, place: 'спортзал', start_time: '12:00', end_time: '13:20')
Pair.create(id: 10, name: 'Экономика', kind: 4, place: '609', start_time: '13:50', end_time: '15:10')
Pair.create(id: 11, name: 'БЖЧ', kind: 5, place: '705', start_time: '15:20', end_time: '16:40')
...
Pair.create(id: 16, name: 'Физкультура', kind: 3, place: 'спортзал', start_time: '15:20', end_time: '16:40')
(12..16).each { |number| Weekday.find(4).pairs << Pair.find(number) }

# Friday
Pair.create(id: 17, name: 'Философия', kind: 4, place: '612', start_time: '9:00', end_time: '10:20')
