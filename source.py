...
def main():
    ...
    while True:
        ...
        if last_update != {}:
            ...
            if last_chat_text in weekdays_dict_ru:
                last_chat_text = weekdays_dict_en[weekdays_dict_ru.index(last_chat_text)]
            ...
            elif last_chat_text in bus_dict:
            ...
            elif last_chat_text in weekdays_dict_en:
                commands.weekday_timetable(last_chat_id, last_chat_text)
